...
INSERT INTO `user_dtl` VALUES (1,'일이일','aaa@gmail.com','01011112222'),(2,'일이이','bbb@gmail.com','01022223333'),(33,NULL,NULL,NULL),(35,NULL,NULL,NULL),(36,NULL,NULL,NULL),(37,NULL,NULL,NULL),(38,NULL,NULL,NULL),(39,NULL,NULL,NULL),(40,NULL,NULL,NULL),(41,NULL,NULL,NULL),(42,NULL,NULL,NULL);
...
INSERT INTO `user_mst` VALUES (1,'test'),(2,'test2'),(33,'zzz'),(35,'aaa'),(36,'bbb'),(37,'ccc'),(38,'ddd'),(39,'aaa'),(40,'bbb'),(41,'ccc'),(42,'eee');
...
-- Dump completed on 2022-12-16 14:37:53
...
LOCK TABLES `score_mst` WRITE;
/*!40000 ALTER TABLE `score_mst` DISABLE KEYS */;
INSERT INTO `score_mst` VALUES (1,1,80),(3,3,90),(4,2,80),(5,2,90),(6,3,70);
/*!40000 ALTER TABLE `score_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `emp_mst` WRITE;
/*!40000 ALTER TABLE `emp_mst` DISABLE KEYS */;
INSERT INTO `emp_mst` VALUES (1,'일이일'),(2,'일이이'),(3,'일이삼'),(4,'일이오');
/*!40000 ALTER TABLE `emp_mst` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
